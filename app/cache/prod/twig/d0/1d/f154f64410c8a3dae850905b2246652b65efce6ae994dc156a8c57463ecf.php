...
class __TwigTemplate_d01df154f64410c8a3dae850905b2246652b65efce6ae994dc156a8c57463ecf extends Twig_Template
{
...
";
    ...
    ";
            ...
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo strtr($_date_pattern_, array("{{ year }}" =>             // line 139
$this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($_form_, "year"), 'widget'), "{{ month }}" =>             // line 140
$this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($_form_, "month"), 'widget'), "{{ day }}" =>             // line 141
...
";
    ...
    public function block_form_start($context, array $blocks = array())
    {
        ...
        echo "    <form name=\"";
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_form_, "vars"), "name"), "html", null, true);
        echo "\" method=\"";
