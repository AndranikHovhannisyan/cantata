 ...
 */
class PrixodRasxod extends \Cantata\MainBundle\Entity\PrixodRasxod implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'prod', 'quantity', 'year', 'month', 'shop');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PrixodRasxod $proxy) {
