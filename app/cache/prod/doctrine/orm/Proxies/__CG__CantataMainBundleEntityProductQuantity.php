...
namespace Proxies\__CG__\Cantata\MainBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ProductQuantity extends \Cantata\MainBundle\Entity\ProductQuantity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'prod', 'quantity', 'year', 'month', 'shop', 'type');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductQuantity $proxy) {
    ...
    public function setMonth($month)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMonth', array($month));
    ...
    public function setProd(\Cantata\MainBundle\Entity\Product $prod = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProd', array($prod));

        return parent::setProd($prod);
    }
